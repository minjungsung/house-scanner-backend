...
func (s *AnalysisService) GetAnalysis(id int) (*models.Analysis, error) {
	return s.repo.GetAnalysis(id)
}

func (s *AnalysisService) UpdateAnalysis(id int, analysis *models.Analysis) error {
	return s.repo.UpdateAnalysis(id, analysis)
}

func (s *AnalysisService) DeleteAnalysis(id int) error {
